...
class GdImage{
	...
	private function get_type($img_name)
	{
        ...
        /**
         * @param string $imgSrc 需要合成的源文件路径
         * @param string $markImg 合成的图片
         * @param string $markText 合成的字体
         * @param string $TextColor 字体颜色
         * $markPos="5";
         * @param string $fontType 字体路径
         * $markType ="text";
         */
	public function setWater($imgSrc) {
            
            $markImg = "";
            $markText = $this -> wm_text;
            $TextColor = $this -> wm_text_color;
            $markPos = 5;
            $fontType = $this -> wm_text_font;
            $markType = 'text';

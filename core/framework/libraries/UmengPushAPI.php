...
class UmengPushAPI {
    ...
    public function sendAndroidBroadcast($ticker,$text,$type,$param) {
        try {
            ...
            $brocast->setPredefinedKeyValue("title", "玩艺网");
            $brocast->setPredefinedKeyValue("text", $text);
            $brocast->setPredefinedKeyValue("after_open", "go_app");
            // Set 'production_mode' to 'false' if it's a test device. 
            // For how to register a test device, please see the developer doc.
            $brocast->setPredefinedKeyValue("production_mode", "true");
            $brocast->setPredefinedKeyValue("description", $ticker);
    ...
    public function sendAndroidUnicast($device_tokens,$ticker,$text,$type,$param) {
        try {
            ...
            $unicast->setPredefinedKeyValue("type", $type); 
            // Set your device tokens here
            $unicast->setPredefinedKeyValue("device_tokens", $device_tokens); 
            $unicast->setPredefinedKeyValue("ticker", $ticker);
            $unicast->setPredefinedKeyValue("icon", "logo");
            $unicast->setPredefinedKeyValue("title", "玩艺网");
            $unicast->setPredefinedKeyValue("text", $text);
            $unicast->setPredefinedKeyValue("after_open", "go_custom");
            $unicast->setPredefinedKeyValue("custom", $param['id']);
            // Set 'production_mode' to 'false' if it's a test device. 
            // For how to register a test device, please see the developer doc.
            $unicast->setPredefinedKeyValue("production_mode", "true");
            $unicast->setPredefinedKeyValue("description", $ticker);
            // Set extra fields
            foreach($param as $k => $v) {
            ...
            //$unicast->setExtraField("id", "helloworld");
    ...
    public function sendIOSBroadcast($text,$type,$param) {
        try {
            $brocast = new IOSBroadcast();
            $brocast->setAppMasterSecret($this->appMasterSecret);
            $brocast->setPredefinedKeyValue("appkey",           $this->appkey);
            $brocast->setPredefinedKeyValue("timestamp",        $this->timestamp);
            $brocast->setPredefinedKeyValue("type", $type);
    ...
    //IOS友盟个推
    public function sendIOSUnicast($device_tokens,$ticker,$text,$type,$param) {
        try {

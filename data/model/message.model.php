...
class messageModel extends Model
{
     ...
     */
    public function listMessage($condition, $page = '', $field = 'message.*')
    {
        //得到条件语句
    ...
    public function saveMessage($param)
    {
        ...
        $array['message_type'] = $param['message_type'] ? '1' : '0';
        $array['type'] = $param['type'];
    ...
    private function getCondition($condition_array)
    {
        ...
        if ($condition_array['type'] != '') {
            $condition_sql .= " and message.type = '{$condition_array['type']}'";
        }
        //站内信类型

	...
	private function _condition($condition){
		...
		if ($condition['ac_parent_id'] != ''){
			...
			if(empty($condition_str)) {
				...
				$condition_str .= "ac_parent_id = '". intval($condition['ac_parent_id']) ."'";
		...
		if ($condition['no_ac_id'] != ''){
			...
			if(empty($condition_str)) {
				...
				$condition_str .= "ac_id != '". intval($condition['no_ac_id']) ."'";
		...
		if ($condition['ac_name'] != ''){
			...
			if(empty($condition_str)) {
				...
				$condition_str .= "ac_name = '". $condition['ac_name'] ."'";
		...
		if ($condition['ac_type'] != ''){
			...
			if(empty($condition_str)) {
				...
				$condition_str .= "ac_type = '". $condition['ac_type'] ."'";

...
class sns_friendModel extends Model{
	 ...
	 * 好友列表
	 *
	 * @param	string $condition	条件数组
	 * @param	string $field 	显示字段
	 * @param	obj $obj_page 	分页
	 * @param	string $type 	查询类型
	 * add by lizh 11:43 2016/8/1
	 */
	public function getListFriend($condition,$field='*',$obj_page='',$order='friend_id desc',$limit='',$group='') {

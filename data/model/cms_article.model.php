...
class cms_articleModel extends Model{
    ...
    public function getOne($condition,$order='',$field='*'){
        $result = $this->table('cms_article')->where($condition)->field($field)->order($order)->find();
        return $result;
    }
    ...
    public function add($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::insert('cms_article',$tmp);
            return $result;
        }else {
            return false;
        }
...
/**
     ...
     * @return bool 布尔类型的返回结果
     */
    public function article_edit($param){
        ...
        if (is_array($param)){
            ...
            $result = Db::update('cms_article',$tmp,$where);
            return $result;
        }else {
            return false;
        }

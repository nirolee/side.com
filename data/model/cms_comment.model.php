...
class cms_commentModel extends Model{
    ...
    */
    public function getOne($condition){
        $result = $this->table('cms_comment')->where($condition)->find();
        return $result;
    }
    ...
    public function save($param){
        return $this->table('cms_comment')->insert($param);	
    }
    ...
    public function saveAll($param){
        return $this->table('cms_comment')->insertAll($param);	
    }
    ...
    public function modify($update, $condition){
        return $this->table('cms_comment')->where($condition)->update($update);
    }
    ...
    public function drop($condition){
        return $this->table('cms_comment')->where($condition)->delete();
    }
